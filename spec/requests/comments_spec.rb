...
RSpec.describe 'Comments API' do
  ...
  let!(:posting) { create(:posting, user_id: user.id) }
  ...
  describe 'GET /postings/:posting_id/comments' do
    before { get "/postings/#{posting_id}/comments", headers: headers }
  ...
  describe 'GET /postings/:posting_id/comments/:id' do
    before { get "/postings/#{posting_id}/comments/#{id}", headers: headers }
  ...
  describe 'POST /postings/:posting_id/comments' do
    ...
    context 'when request attributes are valid' do
      before { post "/postings/#{posting_id}/comments", params: valid_attributes, headers: headers }
    ...
    context 'when an invalid request' do
      before { post "/postings/#{posting_id}/comments", params: {}, headers: headers }
  ...
  describe 'PUT /postings/:posting_id/comments/:id' do
    ...
    before { put "/postings/#{posting_id}/comments/#{id}", params: valid_attributes, headers: headers }
  ...
  describe 'DELETE /postings/:id' do
    before { delete "/postings/#{posting_id}/comments/#{id}", headers: headers }
